...
// app/tailwind.css
var tailwind_default = "/build/_assets/tailwind-FHTBYKG2.css";
...
var loader = async ({ params }) => {
  ...
  const PathToMDX = path_server_default.join(process.cwd(), "posts", `${params.slug}`, "index.mdx");
  console.log(PathToMDX);
  const rootDir = PathToMDX.replace(/index.mdx?$/, "");
  const result = await (0, import_mdx_bundler2.bundleMDX)({
    source: import_fs2.default.readFileSync(PathToMDX, "utf8"),
    cwd: rootDir
  });
  if (!result)
    return null;
...
function BlogIndex() {
  const loader3 = (0, import_remix6.useLoaderData)();
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h2", null, "Posts"), /* @__PURE__ */ React.createElement("p", null, loader3));
}
